...
p. Thinking on how to implement it and some other practical stuff, like my current
personal page layout for instance, drives me to a new version that should look like this:
...
p. If you are on lazy days, or have no HTML/CSS skills at all, you can grab
all that HTML/CSS work fn1. from this sprint @public@ folder.

p. After a few working hours I came up with this fn2. version:

!https://github.com/marcric/ror3gangsclock/wiki/r3gc_sprint-02_01.png!

p. And using the CSS cascading properties it could be easily transformed in this one:
