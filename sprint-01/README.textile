...
# Access and test the application using: @http://0.0.0.0:3000@
...
# Send a @Ctrl-C@ to shutdown server
...
# Creating the initial Home controller, with Index, About and Signin actions.
...
# Test each of the actions now available using:

@http://localhost:3000/home/index@
@http://localhost:3000/home/about@
@http://localhost:3000/home/signin@

p. They all should work displaying a "Find me in..." message in a rough page.
...
# Back to the common application layout.
