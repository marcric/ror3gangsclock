...
* You can also copy the @favicon.ico@ file from the @resources@ folder to the @r3gc/public/images@
one and start seeing an icon in the browser's address bar and in the tab where the page is beeing show.
